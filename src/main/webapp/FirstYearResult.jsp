...
<head>
<meta charset="UTF-8">
<title>First Year Result</title>
<link rel = "icon" href = "Images\logo.jpg">
<link rel = "stylesheet" href = "CSS\FirstYearResult.css">
</head>
<body >
<center>
<div>
...
<%
	...
	con = (Connection)sc.getAttribute("database");
		try {
			PreparedStatement pstmt = con.prepareStatement("select * from student natural join firstyear where Roll_No =?");
