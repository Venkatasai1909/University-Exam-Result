...
<head>
<meta charset="UTF-8">
<title>Fourth Year Result</title>
<link rel = "icon" href = "Images\logo.jpg">
<link rel = "stylesheet" href = "CSS\FourthYearResult.css">
</head>
<body >
<center>
<div>
  <img src = "Images\UniversityLogo.gif">
  <h2>Fourth Year Results</h2>
...
<%
	...
	con = (Connection)sc.getAttribute("database");
		try {
			PreparedStatement pstmt = con.prepareStatement("select * from student natural join fourthyear where Roll_No =?");
